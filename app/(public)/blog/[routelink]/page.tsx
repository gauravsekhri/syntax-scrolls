    ...
    <>
      <div className="min-h-screen py-14 grid grid-cols-12 gap-4">
        <div className="col-span-12 lg:col-span-8 bg-card p-6 rounded-lg">
          ...
          <p>
            If you're a developer, you probably use the versioning system called
            Git on a daily basis. The use of this tool is crucial for the
            development process of an application, whether working in a team or
            individually. However, it's common to encounter messy repositories,
            commits with unclear messages that don't convey useful information,
            and misuse of branches, among other issues. Knowing how to use Git
            correctly and following good practices is essential for those who
            want to excel in the job market.
          </p>
        </div>
          ...
          <div className="flex flex-col justify-center p-12 shadow-md rounded-lg sm:px-12 dark:bg-card dark:text-gray-100">
            ...
            <div className="space-y-4 text-center divide-y dark:divide-gray-700">
              <div className="my-2 space-y-1 pb-3">
                <h2 className="text-xl font-semibold sm:text-2xl text-primary">
                  Gaurav Sekhri
                </h2>
              ...
              <div className="flex justify-center pt-6 space-x-4 align-center">
                <a
                  ...
                  href="#"
                  aria-label="GitHub"
                  className="p-2 rounded-md dark:text-gray-100 hover:dark:text-primary"
                >
                  <svg
                    viewBox="0 0 496 512"
